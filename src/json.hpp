...
template <template <typename U, typename V, typename... Args> class ObjectType =
          ...
          class NumberUnsignedType = uint64_t, class NumberFloatType = double,
...
class basic_json {
  ...
  */
  basic_json(std::initializer_list<basic_json> init, bool type_deduction = true,
    ...
    for (const auto& element : init) {
      if (not element.is_array() or element.size() != 2 or
          not element[0].is_string()) {
    ...
    if (not type_deduction) {
      ...
      if (manual_type == value_t::object and not is_an_object) {
        LOG(FATAL) << "cannot create object from initializer list";
      }
    }
  ...
  */
  ...
  basic_json(InputIT first, InputIT last)
    ...
    if (first.m_object != last.m_object) {
      LOG(FATAL) << "iterators are not compatible";
    }
    ...
    switch (m_type) {
      ...
      case value_t::string: {
        if (not first.m_it.primitive_iterator.is_begin() or
          ...
          LOG(FATAL) << "iterators out of range";
        }
        break;
      }
    ...
    switch (m_type) {
      ...
      default: {
        assert(first.m_object != nullptr);
        LOG(FATAL) << "cannot use construct with iterators from "
 ...
 private:
  ...
  T get_impl(T*) const {
    if (is_object()) {
      ...
      LOG(FATAL) << "type must be object, but is " << type_name();
    }
  }
  ...
  T get_impl(T*) const {
    if (is_array()) {
      ...
      LOG(FATAL) << "type must be array, but is " << type_name();
    }
  }
  ...
  T get_impl(T*) const {
    if (is_string()) {
      ...
      LOG(FATAL) << "type must be string, but is " << type_name();
    }
  }
  ...
  T get_impl(T*) const {
    switch (m_type) {
      ...
      default: { LOG(FATAL) << "type must be string, but is " << type_name(); }
    }
  }
  ...
  constexpr boolean_t get_impl(boolean_t*) const {
    return is_boolean()
               ? m_value.boolean
               : LOG(FATAL) << "type must be boolean, but is " << type_name();
  }
  ...
  /// get a pointer to the value (integer number)
  constexpr const number_integer_t* get_impl_ptr(const number_integer_t*) const
      noexcept {
    return is_number_integer() ? &m_value.number_integer : nullptr;
  }
  ...
  /// get a pointer to the value (floating-point number)
  constexpr const number_float_t* get_impl_ptr(const number_float_t*) const
      noexcept {
    return is_number_float() ? &m_value.number_float : nullptr;
  }
  ...
  */
  ...
  static ReferenceType get_ref_impl(ThisType& obj) {
    ...
    if (ptr != nullptr) {
      ...
      LOG(FATAL) << "incompatible ReferenceType for get_ref, "
                    "actual type is "
                 << obj.type_name();
    }
  }
  ...
  */
  reference at(size_type idx) {
    ...
    if (!is_array()) {
      LOG(FATAL) << "cannot use at() with " << type_name();
    }
  ...
  */
  reference operator[](size_type idx) {
    CHECK(is_null() || is_array()) << "cannot use operator[] with "
                                   << type_name();
  ...
  */
  const_reference operator[](size_type idx) const {
    CHECK(is_array()) << "cannot use operator[] with " << type_name();
    assert(m_value.array != nullptr);
    return m_value.array->operator[](idx);
  }
  ...
  */
  reference operator[](const typename object_t::key_type& key) {
    CHECK(is_null() || is_object()) << "cannot use operator[] with "
                                    << type_name();
  ...
  */
  const_reference operator[](const typename object_t::key_type& key) const {
    CHECK(is_object()) << "cannot use operator[] with " << type_name();
  ...
  */
  ...
  ValueType value(const typename object_t::key_type& key,
    ...
    CHECK(is_object()) << "cannot use value() with " << type_name();
  ...
  */
  ...
  InteratorType erase(InteratorType pos) {
    // make sure iterator fits the current value
    CHECK(this == pos.m_object) << "iterator does not fit current value";
    ...
    switch (m_type) {
      ...
      case value_t::string: {
        if (not pos.m_it.primitive_iterator.is_begin()) {
          LOG(FATAL) << "iterator out of range";
        }
      ...
      default: { LOG(FATAL) << "cannot use erase() with " << type_name(); }
    }
  ...
  */
  ...
  InteratorType erase(InteratorType first, InteratorType last) {
    ...
    if (this != first.m_object or this != last.m_object) {
      LOG(FATAL) << "iterators do not fit current value";
    }
  ...
  */
  size_type erase(const typename object_t::key_type& key) {
    CHECK(is_object()) << "cannot use erase() with " << type_name();
    assert(m_value.object != nullptr);
  ...
  */
  void erase(const size_type idx) {
    ...
    if (is_array()) {
      ...
      LOG(FATAL) << "cannot use erase() with " << type_name();
    }
  }
  ...
  */
  void push_back(basic_json&& val) {
    ...
    if (not(is_null() or is_array())) {
      LOG(FATAL) << "cannot use push_back() with " << type_name();
    }
  ...
  */
  iterator insert(const_iterator pos, const basic_json& val) {
    CHECK(is_array()) << "cannot use insert() with " << type_name();

    // check if iterator pos fits to this JSON value
    if (pos.m_object != this) {
      LOG(FATAL) << "iterator does not fit current value";
    }
  ...
  */
  iterator insert(const_iterator pos, const_iterator first,
    ...
    if (not is_array()) {
      LOG(FATAL) << "cannot use insert() with " << type_name();
    }
    ...
    if (first.m_object != last.m_object) {
      LOG(FATAL) << "iterators do not fit";
    }

    if (first.m_object == this or last.m_object == this) {
      LOG(FATAL) << "passed iterators may not belong to container";
    }
  ...
  */
  void swap(array_t& other) {
    CHECK(is_array()) << "cannot use swap() with " << type_name();
  ...
  */
  void swap(object_t& other) {
    CHECK(is_object()) << "cannot use swap() with " << type_name();
  ...
  */
  void swap(string_t& other) {
    CHECK(is_string()) << "cannot use swap() with " << type_name();
   ...
   public:
    ...
    reference operator*() const {
      ...
      switch (m_object->m_type) {
        ...
        default: {
          CHECK(m_it.primitive_iterator.is_begin()) << "cannot get value";
          return *m_object;
        }
      }
    }
    ...
    bool operator<(const const_iterator& other) const {
      ...
      switch (m_object->m_type) {
        case basic_json::value_t::object: {
          LOG(FATAL) << "cannot compare order of object iterators";
          return false;
        }
    ...
    const_iterator& operator+=(difference_type i) {
      ...
      switch (m_object->m_type) {
        case basic_json::value_t::object: {
          LOG(FATAL) << "cannot use offsets with object iterators";
          break;
        }
    ...
    reference operator[](difference_type n) const {
      ...
      switch (m_object->m_type) {
        case basic_json::value_t::object: {
          LOG(FATAL) << "cannot use operator[] for object iterators";
          return *m_object;
        }
        ...
        default: {
          CHECK(m_it.primitive_iterator == -n) << "cannot get value";
          return *m_object;
        }
      }
    }
    ...
    static string_t to_unicode(const std::size_t codepoint1,
      ...
      if (codepoint1 >= 0xD800 and codepoint1 <= 0xDBFF) {
        ...
        if (codepoint2 >= 0xDC00 and codepoint2 <= 0xDFFF) {
          ...
          LOG(FATAL) << "missing or wrong low surrogate";
        }
      }
      ...
      if (codepoint < 0x80) {
        ...
        LOG(FATAL) << "code points above 0x10FFFF are invalid";
      }
    ...
    token_type scan() noexcept {
...

      {
        ...
        static const unsigned char yybm[] = {
            ...
            32,  0,   0,   128, 128, 128, 128, 128, 128, 128, 128, 128, 128,
            128, 128, 128, 128, 128, 128, 160, 128, 0,   128, 128, 128, 128,
            ...
            case 'u': {
              ...
              if (codepoint >= 0xD800 and codepoint <= 0xDBFF) {
                ...
                if ((i + 6 >= m_limit) or *(i + 5) != '\\' or *(i + 6) != 'u') {
                  LOG(FATAL) << "missing low surrogate";
                }
    ...
    void get_number(basic_json& result) const {
      ...
      if (result.m_type == value_t::number_float) {
        ...
        result.m_value.number_float =
            str_to_float_t(static_cast<number_float_t*>(nullptr), &endptr);

        // anything after the number is an error
        if (reinterpret_cast<lexer_char_t*>(endptr) != m_cursor) {
          LOG(FATAL) << std::string("parse error - ") << get_token()
                     << " is not a number";
        }
      }
    }
...
inline nlohmann::json operator"" _json(const char* s, std::size_t) {
  return nlohmann::json::parse(
      reinterpret_cast<const nlohmann::json::string_t::value_type*>(s));
}
